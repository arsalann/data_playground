...
name: contoso_v2_staging.payroll_summary_monthly
type: bq.sql
description: |
...
depends:
  - contoso_v2_raw.payroll
  - contoso_v2_raw.employees
...
columns:
  ...
  - name: department_key
    type: INTEGER
    description: |
      Department identifier (1-12) referencing contoso_v2_raw.departments. Primary key component enabling
...
WITH payroll_deduped AS (
    SELECT *
    FROM contoso_v2_raw.payroll
    WHERE payroll_key IS NOT NULL
      AND reversal_of_payroll_key IS NULL
