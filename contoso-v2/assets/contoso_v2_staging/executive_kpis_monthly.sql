...
name: contoso_v2_staging.executive_kpis_monthly
type: bq.sql
description: |
...
depends:
  ...
  - contoso_v2_staging.financial_summary_monthly
  - contoso_v2_staging.marketing_performance
  - contoso_v2_staging.support_metrics_monthly
  - contoso_v2_staging.payroll_summary_monthly
...
monthly_opex AS (
    ...
    FROM contoso_v2_staging.financial_summary_monthly
    GROUP BY 1, 2
),
...
monthly_payroll AS (
    ...
    FROM contoso_v2_staging.payroll_summary_monthly
    GROUP BY 1, 2
),
...
monthly_support AS (
    SELECT
        ...
        avg_satisfaction
    FROM contoso_v2_staging.support_metrics_monthly
)
