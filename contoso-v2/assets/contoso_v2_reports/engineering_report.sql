...
name: contoso_v2_reports.engineering_report
type: bq.sql
description: |
  ...
  - Aggregates from ~571 sprint-level records in contoso_v2_staging.engineering_velocity
...
depends:
  - contoso_v2_staging.engineering_velocity
...
FROM contoso_v2_staging.engineering_velocity
GROUP BY 1, 2
ORDER BY year, month
