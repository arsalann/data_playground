...
SELECT
    ...
    DATE_DIFF('day', CAST(o.order_date AS DATE), CAST(sh.ship_date AS DATE)) AS days_to_ship,
    DATE_DIFF('day', CAST(sh.ship_date AS DATE), CAST(sh.delivery_date AS DATE)) AS days_in_transit,
    DATE_DIFF('day', CAST(o.order_date AS DATE), CAST(sh.delivery_date AS DATE)) AS total_lead_days,
