...
name: contoso_v2_staging.engineering_velocity
type: bq.sql
description: |
...
depends:
  - contoso_v2_raw.sprint_tickets
  - contoso_v2_raw.deployments
...
WITH tickets_deduped AS (
    SELECT *
    FROM contoso_v2_raw.sprint_tickets
...
deployments_deduped AS (
    SELECT *
    FROM contoso_v2_raw.deployments
