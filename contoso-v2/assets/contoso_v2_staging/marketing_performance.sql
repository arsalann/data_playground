...
name: contoso_v2_staging.marketing_performance
type: bq.sql
description: |
...
depends:
  - contoso_v2_raw.campaigns
  - contoso_v2_raw.ad_spend_daily
  - contoso_v2_raw.campaign_attribution
...
ad_spend_agg AS (
    ...
    FROM contoso_v2_raw.ad_spend_daily
    GROUP BY campaign_key
),

attribution_deduped AS (
    SELECT *
    FROM contoso_v2_raw.campaign_attribution
