...
name: contoso_v2_reports.marketing_channel_roi
type: bq.sql
description: |
  ...
  Data lineage:
  - Aggregates from contoso_v2_staging.marketing_performance (campaign-level data)
...
FROM contoso_v2_staging.marketing_performance
WHERE total_spend > 0
GROUP BY 1, 2, 3
